  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 w-full">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl text-primary font-semibold mb-4 fade-in fade-in-delay-2">
              Full Stack Developer with a Passion for Backend Engineering
            </p>

            <p className="text-base md:text-lg text-gray-400 max-w-xl fade-in fade-in-delay-3">
              I build scalable web applications, design robust APIs, and explore AI-powered solutions that solve real-world problems.
            </p>
      ...
      <div className="hidden md:flex absolute right-20 top-1/2 -translate-y-1/2 flex-col items-center gap-4 fade-in fade-in-delay-5">
        ...
        <a href="https://github.com/your-username" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-white/5 transition-all text-gray-400" title="GitHub">
        ...
        <a href="https://instagram.com/your-username" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-white/5 transition-all text-gray-400" title="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <a href="https://discord.com/users/your-discord" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-white/5 transition-all text-gray-400" title="Discord">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <a href="https://linkedin.com/in/your-username" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-white/5 transition-all text-gray-400" title="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
