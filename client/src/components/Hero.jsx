  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-6 w-full">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="text-center md:text-left md:w-1/2 lg:w-[55%]">
            ...
            <p className="text-base md:text-lg text-muted max-w-xl min-h-[1.5rem]">
              {descText.split(' ').slice(0, descWords).join(' ')}
              {descWords > 0 && descWords < descText.split(' ').length && <span className="animate-pulse text-muted">|</span>}
            </p>
            ...
            <div className="flex items-center gap-4 mt-6 fade-in fade-in-delay-4 justify-center md:justify-start">
              ...
              <a
                href="/cv.pdf"
                download
                className="px-6 py-3 rounded-full glass text-muted font-medium text-sm hover:text-main hover:bg-glass/10 transition-all inline-flex items-center gap-2"
              >
      ...
      <div className="hidden md:flex absolute right-20 top-1/2 -translate-y-1/2 flex-col items-center gap-4 fade-in fade-in-delay-5 z-20">
        ...
        <a href="https://github.com/csakib049" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-glass/5 transition-all text-muted" title="GitHub">
        ...
        <a href="https://www.instagram.com/s_a_a_k_i_b/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-glass/5 transition-all text-muted" title="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <a href="https://discord.com/users/1081408248197939363" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-glass/5 transition-all text-muted" title="Discord">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <a href="https://www.linkedin.com/in/md-sakib-chowdhury-3990791a8/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:text-primary hover:bg-glass/5 transition-all text-muted" title="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
